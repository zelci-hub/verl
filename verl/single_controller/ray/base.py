...
def _bind_workers_method_to_parent(cls, key, user_defined_cls):
    ...
    for method_name in dir(user_defined_cls):
        ...
        if should_expose:
            ...
            has_magic_attr = hasattr(method, MAGIC_ATTR)
            if has_magic_attr:
            ...
            try:
                ...
                if has_magic_attr and attrs["dispatch_mode"] == Dispatch.DIRECT_ROLLOUT_METHOD and "rollout" in key:
...
def create_colocated_worker_cls(class_dict: dict[str, RayClassWithInitArgs]):
    ...
    remote_cls = ray.remote(max_concurrency=4096)(WorkerDict)
