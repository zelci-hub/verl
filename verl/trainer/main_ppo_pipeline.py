...
def main_task(config, compute_score=None):
    ...
    if config.actor_rollout_ref.actor.strategy == 'fsdp':
        ...
        from verl.workers.fsdp_workers_pipeline import ActorRolloutRefPipelineWorker
    ...
    role_worker_mapping = {
        Role.Actor: ray.remote(ActorRolloutRefPipelineWorker),
        Role.Rollout: ray.remote(ActorRolloutRefPipelineWorker),
        Role.Critic: ray.remote(CriticWorker),
        Role.RefPolicy: ray.remote(ActorRolloutRefPipelineWorker)
    }
